...
export const getOrder = defineTool({
	...
	scopes: ["read_orders"],
	outputFields: ["id", "name", "createdAt", "updatedAt", "displayFinancialStatus", "displayFulfillmentStatus", "totalPriceSet", "subtotalPriceSet", "totalTaxSet", "totalShippingPriceSet", "customer", "lineItems", "fulfillments", "shippingAddress", "billingAddress", "note", "tags"],
	input: {
		id: z.string(),
	},
	graphql: query,
